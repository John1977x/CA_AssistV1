    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 mt-2">Manage and review employee assignments</p>
        </div>
        <button
          onClick={() => navigate('/manager/assignments/create')}
              ...
              <tbody className="divide-y divide-slate-200">
                {filteredAssignments.map(assignment => (
                  <tr key={assignment.assignment_id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <button
                        onClick={() => navigate(`/manager/assignments/${assignment.assignment_id}`)}
