      ...
      <div className="hidden lg:flex lg:w-1/2 bg-emerald-600 flex-col justify-between p-12">
        <div>
          ...
          <p className="text-emerald-100 text-lg leading-relaxed">
            Manage tasks, collaborate with team, and track your work progress.
          </p>
        </div>

        <div className="space-y-4">
          {[
            { icon: '📋', text: 'Manage assigned tasks and deadlines' },
            { icon: '👥', text: 'Collaborate with team members' },
            { icon: '📊', text: 'Track work progress and reports' },
        ...
        <p className="text-emerald-300 text-xs">
          Team collaboration platform for CA Assists
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="text-emerald-600 font-bold text-lg">CA Assists</span>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isLoading ? (
